                        ...
                        {columns.map((col, idx) => (
                            <th
                                ...
                                className={cn(
                                    "table-th",
                                    col.className,
                                    col.enableSorting && onSort ? "cursor-pointer hover:bg-slate-50/50 select-none transition-colors group" : ""
                                )}
                            ...
                            >
                                <div className={cn(
                                    ...
                                    <span className="uppercase tracking-widest text-[10px] font-black">{col.header}</span>
                        ...
                        <tr>
                            <td colSpan={columns.length} className="py-24 text-center">
                                <div className="flex flex-col items-center justify-center gap-4 text-slate-300">
                                    ...
                                    <div>
                                        <p className="text-sm font-black uppercase tracking-widest text-slate-400">No Records In Repository</p>
                                        <p className="text-[10px] font-bold mt-1 opacity-60">Try adjusting your filters or ingestion parameters</p>
                                    </div>
                                </div>
                            </td>
                        </tr>
