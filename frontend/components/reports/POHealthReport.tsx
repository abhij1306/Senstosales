          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-border">
              <tr>
                ...
                <th className="px-4 py-3 text-center text-[11px] font-semibold text-text-secondary uppercase">
                  Status
                </th>
                <th className="px-4 py-3 text-right text-[11px] font-semibold text-text-secondary uppercase">
                  Fulfillment %
              ...
              {data.pos.slice(0, 20).map((po) => (
                <tr key={po.po_number} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-[13px] text-text-primary text-right">
                    {po.ordered_qty.toLocaleString()}
                  </td>
                  <td className="px-4 py-3 text-[13px] text-text-primary text-right">
                    {po.dispatched_qty.toLocaleString()}
                  </td>
                  <td className="px-4 py-3 text-[13px] font-medium text-warning text-right">
                    {po.pending_qty.toLocaleString()}
                  </td>
                  ...
                  <td className="px-4 py-3 text-center">
                    <span
                      className={`inline-flex items-center gap-1 px-2 py-1 rounded text-[10px] font-medium ${getStatusColor(po.fulfillment_status)}`}
                    >
