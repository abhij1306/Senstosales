...
export function TrendsSection({ data, range }: TrendsSectionProps) {
    ...
    const maxValue = Math.max(...data.map(d => Math.max(d.ordered_value, d.invoiced_value)));
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                    <div className="flex justify-between items-center mb-6">
                        <h3 className="text-lg font-semibold text-gray-800">Sales & Dispatch Trends</h3>
                        <div className="flex items-center gap-4 text-xs font-medium">
                            <div className="flex items-center gap-2">
                                <span className="w-3 h-3 rounded-full bg-blue-500"></span> Ordered
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-3 h-3 rounded-full bg-green-500"></span> Invoiced
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative h-64 w-full flex items-end justify-between px-2 gap-2">
                        ...
                        {data.map((item, idx) => (
                            <div key={idx} className="relative flex flex-col items-center flex-1 h-full justify-end group z-10">
                                ...
                                <span className="text-[10px] text-gray-400 mt-2 absolute bottom-0">{item.month}</span>
                    ...
                    <div className="mt-4 p-3 bg-blue-50/50 rounded-lg text-xs text-blue-800 flex items-start gap-2">
                        ...
                        <p>
                            <strong>Insight:</strong> Invoicing is trailing orders by <strong>12%</strong> this quarter. Consider expediting dispatch for pending items.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-center">
                        <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-1">This Quarter Efficiency</h3>
                        ...
                        <p className="text-xs text-gray-400 mt-2">vs Last Quarter (87.5%)</p>
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                        <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4">Pending Breakdown</h3>
                        <div className="space-y-3">
                            <div>
                                ...
                                <div className="h-1.5 w-full bg-gray-100 rounded-full"><div className="h-full bg-red-400 w-[30%]"></div></div>
                            </div>
                            <div>
                                <div className="flex justify-between text-xs font-medium mb-1">
                                ...
                                <div className="h-1.5 w-full bg-gray-100 rounded-full"><div className="h-full bg-amber-400 w-[50%]"></div></div>
                            </div>
                            <div>
                                <div className="flex justify-between text-xs font-medium mb-1">
                                ...
                                <div className="h-1.5 w-full bg-gray-100 rounded-full"><div className="h-full bg-green-400 w-[20%]"></div></div>
                            </div>
                        </div>
                    </div>
                </div>
