...
export default function ResetDatabase() {
    ...
    const handleReset = async () => {
        setIsResetting(true);
        try {
            const response = await fetch("http://localhost:8000/api/system/reset-db", {
                method: "POST",
                headers: {
            ...
            <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-xs text-red-700 mt-1">
                        Reset database will <strong>permanently delete</strong> all business data (POs, DCs, Invoices, SRVs).
                        Master tables (HSN, Consignees) will be preserved. <strong>This action cannot be undone!</strong>
                    </p>
