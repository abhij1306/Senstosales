    ...
    "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1A3D7C] focus-visible:ring-offset-2",
    {
        variants: {
            variant: {
                ...
                default: "bg-[#1A3D7C] text-white hover:bg-[#152F61] active:bg-[#0F2346]",

                // Secondary: Transparent bg, #2BB7A0 border and text
                secondary: "bg-transparent text-[#2BB7A0] border border-[#2BB7A0] hover:bg-[#F6F8FB] active:bg-[#E5E7EB]",

                // Destructive: #DC2626 background, white text
                destructive: "bg-[#DC2626] text-white hover:bg-[#B91C1C] active:bg-[#991B1B]",

                // Ghost: Transparent, subtle hover
                ghost: "bg-transparent text-[#111827] hover:bg-[#F6F8FB] active:bg-[#E5E7EB]",

                // Outline: Border with transparent background
                outline: "bg-transparent text-[#111827] border border-[#D1D5DB] hover:bg-[#F6F8FB] active:bg-[#E5E7EB]",
