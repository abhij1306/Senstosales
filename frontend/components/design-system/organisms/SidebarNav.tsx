        ...
        <div className="w-72 bg-gradient-to-b from-[#1E3A5F] to-[#152841] flex flex-col z-50 shadow-2xl shrink-0">
                        ...
                        >
                            <div className="flex items-center gap-3.5">
                                <item.icon className={cn(
                                    ...
                                    isActive ? "text-[#00BFA6]" : "text-white/50 group-hover:text-white/80"
                                )} />
                                <span className={cn(
            ...
            <div className="p-6 shrink-0 bg-black/20">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-[9px] font-semibold text-[#00BFA6] uppercase tracking-widest">System Operational</span>
                </div>
