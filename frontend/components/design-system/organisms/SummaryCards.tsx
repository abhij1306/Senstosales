...
const variantStyles = {
    ...
    primary: "bg-gradient-to-br from-[#1A3D7C] to-[#152F61] text-white border-transparent",
    secondary: "bg-gradient-to-br from-[#2BB7A0] to-[#1E8A79] text-white border-transparent",
    success: "bg-gradient-to-br from-[#16A34A] to-[#15803D] text-white border-transparent",
    warning: "bg-gradient-to-br from-[#F59E0B] to-[#D97706] text-white border-transparent",
};
...
export const SummaryCard: React.FC<SummaryCardProps> = ({
    ...
    return (
        <Card
            className={cn(
                "flex items-center gap-4 transition-all duration-200 hover:shadow-lg",
...
export const SummaryCards: React.FC<SummaryCardsProps> = ({ cards, className }) => {
    return (
