  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-3">
        ...
        <div className="h-10 w-40 bg-slate-100 animate-pulse rounded-lg" />
      </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="h-24 bg-gradient-to-br from-purple-500/10 to-pink-500/10 animate-pulse rounded-lg border border-slate-200"
          />
        ))}
      </div>
