...
def reset_database(db: sqlite3.Connection = Depends(get_db)):
    ...
    try:
        ...
        db.execute("INSERT OR REPLACE INTO document_sequences (seq_key, current_val, prefix) VALUES ('DC', 0, 'DC'), ('INV', 0, 'INV')")
        ...
        logger.warning(f"✅ DATABASE RESET COMPLETE - {len(deleted_tables)} tables cleared, FK re-enabled")
